...
- **File**: [`MEnginesSection.tsx`](./src/components/MEnginesSection.tsx)
- **Features**:
...
- **File**: [`GeophysicsAstroSection.tsx`](./src/components/GeophysicsAstroSection.tsx)
- **Features**:
...
- **File**: [`PatternExplorerSection.tsx`](./src/components/PatternExplorerSection.tsx)
- **Features**:
