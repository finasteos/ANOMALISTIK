...
- [x] **B3 — De-monolith (P1/M)** — PROGRESS 2026-09-25: `security.ts` + `rng.ts` + **`routes/rng.ts` (449-line RNG section extracted, `createRngRouter`, live-verified identical)**. Remain: split `{geospace,ai,adjudicate,declassified}` routes.
